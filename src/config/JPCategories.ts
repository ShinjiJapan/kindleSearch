...
export const jpCategories: IDropdownOption[] = [
  { key: "2250738051", text: "指定なし" },
  {
    key: "2275256051header",
    text: "Kindle和書",
    itemType: DropdownMenuItemType.Header,
  },
  { key: "2275256051", text: "Kindle和書(ALL)" },
  ...
  { key: "2275259051", text: "Kindle洋書(ALL)" },
